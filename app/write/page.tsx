      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="px-4 py-2 bg-inkPink text-white rounded-lg"
          >
            Log In
          </button>
        </div>
      ...
      <div className="sticky top-0 z-10 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <button
            ...
            disabled={saving}
            className="px-4 py-1.5 bg-inkPink text-white rounded-full text-sm font-medium hover:bg-pink-600 disabled:opacity-50 transition-colors"
          >
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 shadow-sm">
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="w-5 h-5 rounded-md accent-inkPink"
            />
            <div>
